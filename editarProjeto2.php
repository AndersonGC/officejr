<?php include 'conexao.php';
	...
	$SQL = "UPDATE projeto_projeto SET descricao = '".$descricao."', statusProjeto =  '".$statusProjeto."', precoServico = ".$precoServico.", prazoDeEntrega = '".$dataBanco."', grauDificuldade = '".$grauDificuldade."', Cliente_codCliente = ".$Cliente_codCliente.", nome = '".$nome."' WHERE codProjeto = '".$codProjeto."' ";
